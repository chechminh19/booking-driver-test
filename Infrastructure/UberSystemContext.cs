...
public partial class UberSystemContext : DbContext
{
    public UberSystemContext()
    {
    }

    public UberSystemContext(DbContextOptions<UberSystemContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(local);Initial Catalog=UberSystem;User ID=sa;Password=12345;Connect Timeout=30;Encrypt=False;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cab>(entity =>
        {
            ...
            entity.HasIndex(e => e.DriverId, "IX_cabs_driverId");
        ...
        modelBuilder.Entity<Driver>(entity =>
        {
            ...
            entity.HasIndex(e => e.CabId, "IX_drivers_cabId");
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.HasIndex(e => e.TripId, "IX_payments_tripId");
        ...
        modelBuilder.Entity<Rating>(entity =>
        {
            ...
            entity.HasIndex(e => e.CustomerId, "IX_ratings_customerId");

            entity.HasIndex(e => e.DriverId, "IX_ratings_driverId");

            entity.HasIndex(e => e.TripId, "IX_ratings_tripId");
        ...
        modelBuilder.Entity<Trip>(entity =>
        {
            ...
            entity.HasIndex(e => e.CustomerId, "IX_trips_customerId");

            entity.HasIndex(e => e.DriverId, "IX_trips_driverId");

            entity.HasIndex(e => e.PaymentId, "IX_trips_paymentId");
